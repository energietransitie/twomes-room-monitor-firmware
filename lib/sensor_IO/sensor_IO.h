...
#define GREEN_LED_ERROR_D2          GPIO_NUM_12       //Status LED on GPIO12
#define OUTPUT_BITMASK       (1ULL << PIN_SUPERCAP_ENABLE) | (1ULL << RED_LED_ERROR_D1) | (1ULL << GREEN_LED_ERROR_D2)
